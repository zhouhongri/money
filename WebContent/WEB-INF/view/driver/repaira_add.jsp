...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<%=path %>/rapairCtrl/insertrapair">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="repairContent" value="" 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="repairUnit" value="" 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="date" class="input" name="repairDate" value="" 
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="repairMoney" value="" 
