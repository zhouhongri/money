		...
		<div class="panel admin-panel">
            ...
            <div class="padding border-bottom">
				<ul class="search" style="padding-left: 10px;">
					...
					<li>搜索：</li>
					<li><input type="text" placeholder="请输入搜索关键字" id="peccancyId"
						name="peccancyId" class="input"
...
<script>
function query(){
	var peccancyId = $("#peccancyId").val();
	window.location.href="<%=path %>/peccancy/querypeccancyid?peccancyId="+peccancyId;
}
</script>
</html>