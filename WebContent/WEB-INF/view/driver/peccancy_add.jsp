...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-pencil-square-o"></span>违章信息添加</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<%=path %>/peccancy/insertpeccancy">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="peccancyContent" value="" 
          style="width:25%; float:left" placeholder="请输入违章原因" data-validate="required:请输入违章原因"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="date" class="input" name="peccancyDate" value="" 
          style="width:25%; float:left" placeholder="请输违章时间"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
